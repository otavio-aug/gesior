...
if($action == 'show')
{
	...
	else
	{
		...
		<div class="bordertable">
			...
			<div class="Border_3">
				<table border="0" cellspacing="1" cellpadding="4" width="100%">
			        <tbody>
			        	<tr bgcolor="#505050">
			        		<td colspan="3" class="white"><b>Guild Details</b></td>
			        	</tr>
			       		<tr bgcolor="#D4C0A1">
				...
				<table border="0" cellspacing="1" cellpadding="4" width="100%">
			        <tbody><tr bgcolor="#F1E0C6">
			        		<td width="50px"><b>Descrição da Guild</b></td><td width="80%"><p style="max-width: 600px;overflow: hidden;font-size: 10px;">'.$description.'</p></td>
			        	</tr>
			        	<tr bgcolor="#D4C0A1">
			        		<td width="50px"><b>Criador da Guild</b></td><td width="80%"><a href="?subtopic=characters&name='.urlencode($guild_owner).'">'.htmlspecialchars($guild_owner).'</a></a></td>
			        	</tr>
			        	<tr bgcolor="#F1E0C6">
			        		<td width="50px"><b>Data de Criação</b></td><td width="80%">'.date("j F Y", $guild->getCreationData()).'.</td>
			       		</tr>
						<tr bgcolor="#D4C0A1">
							<td width="50px"><b>Membros</td><td width="80%">'.$guildMembers['total'].' membros.</td>
						</tr>
					</tbody>
				</table>
			</div></div></div><br>';
									...
									<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
										<div class="TableContentContainer" >
											<table class="TableContent" width="100%" >
												<tr class="LabelH">
													<td>Rank <small style="font-weight:normal;" ></small> </td>
													<td>Name and Title</td>
													<td>Vocation <small style="font-weight:normal;" ></small> 
													<img class="sortarrow" src="'.$layout_name.'/images/global/general/blank.gif" /></td>
													<td>Level <small style="font-weight:normal;" ></small> 
													<img class="sortarrow" src="'.$layout_name.'/images/global/general/blank.gif" /></td>
													<td>Status</td>
												</tr>';
													...
													foreach($players_with_rank as $player)
													{
														...
														$main_content .= '
															<TR BGCOLOR='.$bgcolor.'>
																...
																<TD>';
																$main_content .= '<FORM ACTION="?subtopic=guilds&action=change_nick&name='.urlencode($player->getName()).'" METHOD="post"><A HREF="?subtopic=characters&name='.urlencode($player->getName()).'">'.htmlspecialchars($player->getName()).'</A>';
											...
											<tr>
												...
												<td align="right" style="padding-right:7px;width:100%;" >
													<form action="?subtopic=guilds" method="post" style="padding:0px;margin:0px;" >
														...
														<a href="?subtopic=guilds&action=manager&guild='.$guild_id.'"><IMG SRC="'.$layout_name.'/images/buttons/sbutton_manageguild.png" BORDER=0 WIDTH=120 HEIGHT=18 alt="Manage Guild"></a>
													</form>
												</td>
											</tr>
										</table>';
		...
		if(count($invited_list) == 0)
			$main_content .= '<BR><BR><div class="TableContainer" >
				<table class="Table3" cellpadding="0" cellspacing="0" >
					<div class="CaptionContainer" >
										...
										<td>
											...
											<div class="TableContentAndRightShadow" style="background-image:url(./layouts/tibiarl/images/global/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													<table class="TableContent" width="100%" >
														<TR BGCOLOR=#F1E0C6>
															<TD align="center">Não há personagens invitados.</TD>
														</TR>
													</table>
												</div>
											</div>
...
if($action == 'createguild')
{
	...
	if($todo == 'save')
	{
		...
		$new_guild->setDescription('Guild nova aguardando o líder editar a descrição.');
