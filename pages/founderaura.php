	...
	<div class="TableContainer">
		<div class="CaptionContainer">
			<div class="CaptionInnerContainer">
				...
				<div class="Text">Founder Pack - Aura Exclusiva</div>
														...
														<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
															<div class="TableContentContainer" >
																<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																	<tr>
																		<td><div style="text-align: justify;">Uma aura visual exclusiva, disponível apenas para os jogadores que obtiveram o Pacote de Fundador.<br><br><font color="red"><b>NOTE QUE:</b></font><br><li>Aura Exclusiva muda apenas o efeito da sua Aura.<br><li>Você recebe apenas um efeito exclusivo da aura. A regeneração da aura não muda.<br><li>Não há outros meios de obter esta aura, apenas pelo pacote de fundador.</div></td>
																	</tr>									
																</table>
															</div>
														</div>											
													...
													<td>
														...
														<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
															<div class="TableContentContainer" >
																<table width="100%">
																	<tr>
																		<td><b>Como obter a Aura Exclusiva?</b></td>
																	</tr>
																</table>
																<table width="100%">
																<tr>
																	<td>
																		<table width="100%">
																		<tr>
																			<td width="5%"><center><img src="/images/items/pages/12885.gif"></center></td><td width="80%">&emsp;Ao usar um <b>Pacote de Fundador</b>. Item exclusivo e por tempo <b><font color="darkred">limitado</font></b>.</td>
																		</tr>
																		</table>
																	</td>
																</tr>
															...
															<div class="TableContentContainer" >
																<table class="table3 table-offers" width="100%"  style="border:1px solid #faf0d7;" >
																	<tr style="background-color:#505050;">
																		<td><font color="white"><b>Imagem da Aura Exclusiva:</b></font></td>
																	</tr>
																	<tr style="background-color:#d4c0a1;">
																		<td><center><img src="images/auraexc.gif" width="710px"></center></td>
																	</tr>																	
																</table>
															</div>
														</div>											
