			...
			$news_content .= '</b>
				<div id="FeaturedArticle" class="Box">
					...
					<div class="Border_2">
						<div class="Border_3">
							<div class="BoxContent" style="background-image:url('.$layout_name.'/images/content/scroll.gif);">
								<div id=\'TeaserThumbnail\'><img src="/images/announcementx.jpg" width=150 height=100 border=1 alt="" /></div>
								<div id=\'TeaserText\'>
									<div style="position: relative; top: -2px; margin-bottom: 2px;" >
										<b>IP:</b> CLASSICYUROTS.COM - <b>VERSION:</b> 8.60 - <b>PORT:</b> 7171
									</div>
									<br><font color="darkred"><b>ClassicYurots</b></font> private Tibia OTServer, <a href="?subtopic=serverinfo">Server Info</a>.<br>
									Utilizamos um <b>Mapa Baiak 100% CUSTOM</b> com todas as Quests e sistemas configurados.<br>
									Servidor sem BUG, sem LAG e com uma excelente segurança e proteção contra DDoS.<br>
									Em nosso servidor você encontrará tudo o que precisa pra ter uma diversão garantida.<br>
									Servidor com capacidade para 1500+ jogadores!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-chevron-circle-right" aria-hidden="true"></i> <a href="?subtopic=serverinfo#dedicatedinfo">Tudo sobre nosso dedicado</a> <i class="fa fa-chevron-circle-left" aria-hidden="true"></i><br>
    ...
    if(isset($last_threads[0]))
    {
        foreach($last_threads as $thread)
        {
            $main_content .= '
				...
				<tr>';
            $main_content .= '
				<td style=\'padding-left:10px;padding-right:10px;\' >' . showPost('', $thread['post_text'], $thread['post_smile']) . '<br><p align="right"><a href="?subtopic=forum&action=show_thread&id=' . $thread['id'] . '">» Comment on this discord</a></p></td>';
